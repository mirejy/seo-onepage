      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mt-4 text-lg font-medium text-black">Efficace</h3>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mt-4 text-lg font-medium text-black">Sicuro</h3>
            <p className="mt-2 text-sm text-black">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mt-4 text-lg font-medium text-black">Effetto duraturo</h3>
            <p className="mt-2 text-sm text-black">
